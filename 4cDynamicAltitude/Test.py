...
def run(Q, R, p_i, additional_noise_w, additional_noise_a):
    ws = ws_ + np.column_stack((w_1, w_2, w_3)) + rng.normal(0, additional_noise_w, (len(w_1), 3))
    ...
    return t_w, w_1, w_2, w_3, t_a, a_1, a_2, a_3, t_w, phi_g, theta_g, psi_g, t_a, phi_a, theta_a, psi_a, phi_f, theta_f, psi_f


t_w, w_1, w_2, w_3, t_a, a_1, a_2, a_3, t_w, phi_g, theta_g, psi_g, t_a, phi_a, theta_a, psi_a, phi_f, theta_f, psi_f = run(Q=Q, R=R, p_i=p_i, additional_noise_w=additional_noise_w, additional_noise_a=additional_noise_a)
...
fig3, (ax7, ax8, ax9) = plt.subplots(3, 1, figsize=(10, 6), sharex=True, sharey=True)
...
# plot euler angles
alpha = 0.8
fig4, (ax4, ax5, ax6) = plt.subplots(3, 1, figsize=(10, 6), sharex=True, sharey=True)
